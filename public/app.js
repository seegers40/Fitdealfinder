...
grid.innerHTML =   <div class="empty-state">   <h3>Deals laden...</h3>   <p>   We halen de actuele producten op.   </p>   </div>  ;
}
...
const image =
product.image_url
?   <img   src="${escapeHtml(   product.image_url   )}"   alt="${escapeHtml(   product.name   )}"   loading="lazy"   onerror="this.style.display='none'"   >  
:   <div class="product-image-placeholder">   FitDealFinder   </div>  ;
...
const dealUrl =
/go/${encodeURIComponent(   String(product.id)   )};
...
const image =
product.image_url
?   <img   src="${escapeHtml(   product.image_url   )}"   alt="${escapeHtml(   product.name   )}"   loading="lazy"   width="65"   height="65"   onerror="this.style.display='none'"   >  
:   <div   class="ai-product-placeholder"   >   FitDealFinder   </div>  ;
